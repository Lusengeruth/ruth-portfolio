const variants = {
  ...
  fullstack:'bg-purple-100 dark:bg-purple-900 text-purple-500 dark:text-purple-300',
...
export default function Badge({ category }) {
  return (
    <span className={`inline-block text-xs font-semibold rounded-full px-3 py-1 ${variants[category] || variants.frontend}`}>
